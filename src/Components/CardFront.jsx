...
export default function CardFront({playerName, playerImg, btnRequired, flagImg, basePrice,color1,color2,flip , scale}) {
    const b = {
    ...
    return (
        ...
        <div className='player-img'><img src={`media/player/${playerImg}`} onError={imageOnError}  alt="" /></div>
            
                
                <div className='card-footer' style={{...(btnRequired?{'borderRadius':'0px'}:{})}}>
                    <div className='flag'><img src={`../media/flag/${flagImg}`}  alt="" /></div>
